...
- Choose which stats show and in what order (**Mod Menu → HQTiers → Nametag**)

### Leaderboards & Profiles
- In-game leaderboard: scroll through pages, switch ladders and click a player to open their profile
- Search for players by name
- View ladder stats, leaderboard positions and rating history
